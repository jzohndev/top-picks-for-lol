...
public class FragmentWins extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragmentwins_layout, container, false);
        setRetainInstance(true);
        try {
            MainHandler x = new MainHandler();
            champArray = x.getTopWinChamps();
            champArrayPercent = x.getTopWinChampsPercent();
        } catch (IOException e) {
            e.printStackTrace();
        }
